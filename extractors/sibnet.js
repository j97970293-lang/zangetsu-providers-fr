var INFO={id:'sibnet',name:'Sibnet',version:'1.0.0',hosts:['video.sibnet.ru']};
...
async function extract(url, opts) { try { var h=await fetch(url,{headers:{Referer:'https://video.sibnet.ru/'}}); var u=pick(h.body,url); return u?result(u,'https://video.sibnet.ru/'):[]; } catch (_) { return []; } }
