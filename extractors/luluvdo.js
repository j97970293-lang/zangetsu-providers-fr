var INFO={id:'luluvdo',name:'Luluvdo',version:'1.0.0',hosts:['luluvdo.com', 'luluvdoo.com', 'luluvid.com']};
...
async function extract(url, opts) { try { var h=await fetch(url,{headers:{Referer:url}}); var u=pick(h.body,url); return u?result(u,url):[]; } catch (_) { return []; } }
