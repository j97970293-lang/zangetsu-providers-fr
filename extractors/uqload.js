var INFO={id:'uqload',name:'Uqload',version:'1.0.0',hosts:['uqload.com', 'uqload.cx', 'uqload.co', 'uqload.to']};
...
async function extract(url, opts) { try { var h=await fetch(url,{headers:{Referer:url}}); return pick(h.body,url)?result(pick(h.body,url),url):[]; } catch (_) { return []; } }
